...
public abstract class VideoRecorder {
    ...
    public final void stop(boolean isCameraShutdown) {
        synchronized (mStateLock) {
            if (mState == STATE_IDLE) {
                ...
                LogUtil.e("stop:", "called twice, or called before start! " +
                        "Ignoring. isCameraShutdown:" + isCameraShutdown);
                return;
            }
            LogUtil.i("stop:", "Changed state to STATE_STOPPING : isCameraShutdown === " + isCameraShutdown);
    ...
    @SuppressWarnings("WeakerAccess")
    @CallSuper
    protected void dispatchEncodeStart(int videoBitrate) {
